...
rule SupperBackdoor : FILE {
    ...
    strings:
		...
		$a2 = { C7 45 E0 6B 65 72 6E C7 45 E4 65 6C 33 32 C7 45 E8 2E 64 6C 6C C6 45 EC 00 }

	condition:
	    uint16(0)==0x5a4d and filesize <1500KB and (pe.version_info["LegalCopyright"] contains " Team" and pe.version_info["CompanyName"] contains " Team") and any of ($a*)
}
